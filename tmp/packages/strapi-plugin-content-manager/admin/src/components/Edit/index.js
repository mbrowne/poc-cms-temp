...
class Edit extends React.PureComponent {
    ...
    getInputLayout = attr => {
        ...
        return Object.keys(get(layout, ['properties', attr], {})).reduce(
            (acc, current) => {
                acc[current] = isFunction(layout.properties[attr][current])
                    ? layout.properties[attr][current](this)
                    : layout.properties[attr][current]
    ...
    orderAttributes = () => this.props.displayAttributes
    ...
    renderAttr = (attr, key) => {
        ...
        //     attr,
        // ])
        const details = this.props.entityDef.properties[attr]
    ...
    render() {
        return (
            <div className={styles.form}>
                <div className="row">
                    {this.orderAttributes().map(attr =>
                        this.renderAttr(attr.id)
                    )}
                </div>
            </div>
        )
